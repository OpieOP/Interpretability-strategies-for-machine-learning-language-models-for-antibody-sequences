...
def extract_embeddings_and_save(model, dataloader):
    ...
    np.save("/home/om423/saves/embeddings_medium.npy", embeddings)
    np.save("/home/om423/saves/attentions_medium.npy", attention_scores)
    np.save("/home/om423/saves/f_embeddings_medium.npy", first_embeddings)
...
def main():
    ...
    model_config = RobertaConfig(
        ...
        num_hidden_layers=antiberta_config.get("num_hidden_layers", 6),
        num_attention_heads=antiberta_config.get("num_attention_heads", 6),
    ...
    training_args = TrainingArguments(
        output_dir="/home/om423/saves/checkpoints_medium",
        ...
        seed=2024,
        logging_dir='/home/om423/logs/script_medium', 
    )
    ...
    last_checkpoint = "/home/om423/saves/checkpoints_medium/checkpoint-390000"
    ...
    trainer.save_model("/home/om423/saves/antiberta_medium")
